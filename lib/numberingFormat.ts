...
export const CODE_FIELD_ENTITY_MAP: { field: string; entityType: string; status: CodeFieldStatus; note: string }[] = [
  ...
  { field: "customerCode", entityType: "CUSTOMER", status: "converted", note: "AG: system-generated, immutable; legacy rows keep NULL" },
  { field: "siteCode", entityType: "CUSTOMER_SITE", status: "converted", note: "AG: system-generated, immutable; distinct from cityCode/zoneCode classifiers" },
  { field: "vehicleCode (plateNumber stays manual)", entityType: "VEHICLE", status: "converted", note: "AG: internal code generated; plate remains the manual legal/physical identifier" },
  { field: "driverCode (licenseNumber stays manual)", entityType: "DRIVER", status: "converted", note: "AG: internal code generated; license remains the manual legal identifier" },
  { field: "loadingPointCode", entityType: "LOADING_POINT", status: "converted", note: "AG: system-generated on warehouses (the loading-point table), distinct from maintenance warehouses" },
